const db = [
  {
    ...
    contenido: `
			<p>El proceso del módulo didáctico consta de tuberías de hierro y de PVC para transportar agua y el caudal es controlado por medio de distintos instrumentos instalados en el módulo.</p>
			...
			<p><strong>Figura 1. Tanque de 460 litros del módulo didáctico</strong></p>
  ...
  },
  {
    ...
    contenido: `
			<p>La Bomba Centrífuga (Figura 1) transporta el agua almacenada en el Tanque de Suministro de Agua a través del sistema de tuberías del módulo didáctico. El agua es succionada por la bomba centrifuga y luego de recorrer todo el proceso, es retornada al tanque, donde nuevamente es succionada por la bomba y el ciclo se repite continuamente.</p>
  ...
  },
  {
    ...
    contenido: `
			<p>Todo sistema de control de lazo cerrado requiere de un elemento de medición para conocer el valor de la variable a controlar (en este caso: caudal). En el proceso del módulo didáctico, el elemento de medición está constituido por un transmisor y por un elemento primario (este puede ser el Tubo Venturi o la Placa Orificio del proceso).</p>
			...
			<p><strong>Figura 1. Transmisor de presión diferencial del módulo didáctico</strong></p>
  ...
  },
  {
    ...
    contenido: `
			...
			<p><strong>Figura 2. Placa orificio del módulo didáctico</strong></p>
			<img src="img/informacion/placa_orificio_2.jpg">
			<p><strong>Figura 3. Bridas para instalar la placa orificio del módulo didáctico</strong></p>
  ...
  },
  {
    ...
    contenido: `
			...
			<p>La Figura 2 muestra el Tubo Venturi del módulo didáctico, en la imagen se pueden observar las tomas de alta y baja presión. La Figura 3 muestra el tubo venturi instalado en el módulo junto con dos uniones universales para fácil desmontaje en caso de mantenimiento y dos válvulas tipo bola en las tomas de presión. </p>
			<p><strong>Figura 2. Tubo Venturi del módulo didáctico</strong></p>
			<img src="img/informacion/venturi_2.jpg">
			<p><strong>Figura 3. Tubo Venturi instalado en el módulo didáctico</strong></p>
			<img src="img/informacion/venturi_3.jpg">
			<p>La diferencia de presión ocasionada por el tubo venturi del módulo didáctico es medida por el Transmisor de Presión Diferencial para así determinar el caudal en la tubería donde se halla instalado el tubo venturi.</p>
  ...
  },
  {
    ...
    contenido: `
			...
			<p>El convertidor I/P del proceso es el modelo “Type 1000” de la empresa “MARSH BELLOFRAM”. La (Figura 1) muestra un equipo nuevo, mientras que la (Figura 2) muestra el equipo usado en el módulo didáctico.</p>
			<p><strong>Figura 1. Convertidor I/P</strong></p>
			<img src="img/informacion/convertidor_1.jpg">
			<p><strong>Figura 2. Convertidor I/P del módulo didáctico</strong></p>
  ...
  },
  {
    ...
    contenido: `
			...
			<p>El módulo didáctico cuenta con una Válvula de Control neumática (Figura 1) como elemento final de control, permitiendo al sistema de control de lazo cerrado alterar el caudal que fluye a través del sistema de tuberías.</p>
			<p><strong>Figura 1. Válvula de control neumático del módulo didáctico</strong></p>
  ...
  },
  {
    ...
    contenido: `
			...
			<p>El Presostato (Figura 1) usado en el proceso del módulo didáctico es de la marca “Honeywell” y es el modelo “L404”. Este presostato supervisa la presión del aire en la tubería de suministro de aire comprimido (estas tuberías son de color azul y están etiquetadas con la palabra “Aire”).</p>
			<p><strong>Figura 1. Presostato del módulo didáctico</strong></p>
...

  {
    ...
    contenido: `
			...
			<p>El Breaker Principal (Figura 1) del tablero de control del módulo didáctico soporta una corriente máxima de 32 A antes de abrirse para proteger el circuito. Este breaker permite el paso de corriente a todos los dispositivos eléctricos del módulo. Si no se activa (colocando su palanca hacia arriba, en la posición “on”), el módulo no se podrá encender.</p>
  ...
  },
  {
    ...
    contenido: `
			...
			<p>El Controlador Electrónico (Figura 1) del módulo didáctico es el modelo “Control 3000” de la empresa “Venetrol”. Este controlador lee la señal estándar de 4 a 20 mA proveniente del Transmisor de Presión Diferencial y produce como salida una señal estándar de 4 a 20 mA que se envía al Convertidor I/P. Este último traduce esta señal en una señal neumática de 3 a 15 psi para así accionar la Válvula de Control.</p>
			...
			<p><strong>Figura 1. Controlador Venetrol del módulo didáctico</strong></p>
			...
			<p><strong>Figura 2. Sección inferior del tablero de control del módulo didáctico</strong></p>
			<img src="img/informacion/controlador_2.jpg">
			<p style="color:red">El módulo didáctico en la actualidad (2021) no cuenta con este instrumento, lo que impide el control de caudal. La Figura 2 muestra donde originalmente se hallaba instalado: la sección inferior del tablero de control.</p>
		`,
  },
  {
    id: "selector",
  ...
  },
  {
    ...
    contenido: `
			<p style="color:green">Este dispositivo es un elemento interactivo del aula virtual. Puede hacer clic sobre él con el ratón (o tocar con su dedo, en caso de estar en un dispositivo móvil) para accionarlo.</p>
			<p>Cuando el Selector de Modo de Operación se halla en el modo manual, el operador del módulo didáctico puede poner en marcha y parar la Bomba Centrifuga a voluntad.</p>
  ...
  },
  {
    ...
    contenido: `
			<p>La Luz de Control de Proceso Bloqueado (Figura 1) es una luz indicadora que informa cuando cualquiera de los tres Interruptores de Emergencia del módulo ha sido accionado, provocando la parada inmediata de la Bomba Centrifuga. Además, la bomba tampoco podrá ser puesta en marcha mientras alguno de los interruptores este accionado.</p>
