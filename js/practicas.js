const practicas = [
  {
    ...
    pasos: [
      {
        texto:
          "Señalar en la imagen con una “X” las válvulas tipo bola presentes en el módulo. (Presione una “X” y arrástrela para moverla).",
      ...
      {
        texto:
          "Señalar en la imagen con una “X” la placa orificio presente en el módulo.",
      ...
      {
        texto:
          "Señalar en la imagen con una “X” el tubo venturi presente en el módulo.",
      ...
      {
        texto:
          "Señalar en la imagen con una “X” el rotámetro presente en el módulo.",
      ...
      {
        texto:
          "Señalar en la imagen con una “X” la bomba centrifuga presente en el módulo.",
      ...
      {
        texto:
          "Señalar en la imagen  con una “X” los selectores de parada de emergencia.",
      ...
      {
        texto:
          "Señalar en la imagen con una “X” el presostato presente en el módulo.",
      ...
      {
        texto:
          "Señalar en la imagen con una “X” el filtro de línea de la bomba centrifuga.",
      ...
      {
        texto:
          "Señalar en la imagen con una “X” el convertidor I/P presente en el módulo.",
      ...
      {
        texto:
          "Señalar en la imagen con una “X” el tanque de almacenamiento de agua.",
...

  {
    ...
    pasos: [
      {
        texto:
          "Señalar en la imagen con una “X” el botón de parada de emergencia presente en el tablero de control.",
        ...
        preguntas: ["¿Qué función cumple el botón de parada de emergencia?"],
      },

      {
        texto:
          "Señalar en la imagen con una “X” el selector de modo de operación.",
        ...
        preguntas: ["¿Qué función cumple el selector de modo de operación?"],
      },

      {
        texto:
          "Señalar en la imagen con una “X” el pulsador luminoso de encendido.",
        ...
        preguntas: ["¿Qué función cumple el pulsador luminoso de encendido?"],
      },

      {
        texto:
          "Señalar en la imagen con una “X” o con O el pulsador luminoso de apagado.",
        ...
        preguntas: ["¿Qué función cumple el pulsador luminoso de apagado?"],
      },

      {
        texto:
          "Señalar en la imagen con una “X” las luces indicadoras de fallo de aire, sobrecarga, control de proceso bloqueado y válvula solenoide presentes en el tablero.",
      ...
      {
        texto:
          "Señalar en la imagen con una “X” el controlador Venetrol 3000 presente en el tablero de control.",
      ...
      {
        texto:
          "Señalar en la imagen con una “X” el breaker principal del tablero.",
        ...
        preguntas: ["¿Qué función cumple el breaker principal del tablero?"],
      },
      ...
      {
        texto:
          "Señalar en la imagen con una “X” los relés presentes en el tablero de control.",
...

  {
    ...
    pasos: [
      ...
      {
        texto:
          "Intentar accionar los pulsadores luminosos de encendido y apagado.",
        preguntas: [
...

  {
    ...
    pasos: [
      ...
      {
        texto:
          "Abrir la pestaña “Fallas” de la página y activar la casilla “Falla de tensión eléctrica” para simular una falla con la tensión eléctrica.",
      ...
      {
        texto:
          "Intentar poner en marcha la bomba colocando el selector de modo de operación en la posición “AUTOMATICO”.",
      ...
      {
        texto:
          "Remover la falla de tensión eléctrica dirigiéndose a la pestaña “Fallas” y desactivando la casilla “Falla de tensión eléctrica”.",
      ...
      {
        texto:
          "Activar la falla de tensión nuevamente (como en el paso 4) estando la bomba centrifuga en marcha.",
...

  {
    ...
    pasos: [
      ...
      {
        texto:
          "Colocar el selector de modo de operación en la posición “MANUAL”.",
      },

      {
        texto:
          "Poner en marcha la bomba centrífuga accionando el pulsador luminoso de encendido.",
      },

      {
        texto:
          "Abrir la pestaña “Fallas” de la página y activar la casilla llamada “Sobrecarga en la bomba centrífuga” para simular una sobrecarga en la bomba centrífuga.",
      ...
      {
        texto:
          "Intentar poner en marcha la bomba presionando el pulsador de encendido.",
      ...
      {
        texto:
          "Intentar poner en marcha la bomba presionando el pulsador luminoso de encendido.",
...

  {
    ...
    pasos: [
      ...
      {
        texto:
          "Abrir la pestaña “Fallas” en el menú lateral de la página y activar la casilla “Falla de suministro de aire”.",
      ...
      {
        texto:
          "Remover la falla de suministro de aire dirigiéndose a la pestaña “Fallas” y desactivando la casilla “Falla de suministro de aire”.",
      },
